...
- Reworked the Live Ticks list so it no longer shows empty bid and ask values as zeroes; each tick now shows the latest price, tick movement, 24-hour high and low, compact quote volume, and trade count.
