...
it('renders the realtime markets dashboard from stored market data', function (): void {
    ...
    get('/markets')
        ...
        ->assertSee('data-live-tick-row', false)
        ->assertSee(__('ui.market.tick_range', ['high' => '72,000.00', 'low' => '69,000.00']))
        ->assertSee('Объём 8.53M / Сделки 1.00K')
        ->assertDontSee('0.00000000 / 0.00000000')
        ...
        ->assertSee('data-market-pulse-chart', false)
        ->assertSee(__('ui.market.market_pulse_chart'))
